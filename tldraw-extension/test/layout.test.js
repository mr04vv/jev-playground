...
test("layoutGroups stacks each group in a column, largest group first", () => {
  const notes = {
    a: { w: 200, h: 200 },
    b: { w: 200, h: 250 },
    c: { w: 200, h: 200 },
  ...
  assert.deepEqual(positions, [
    { id: "a", x: 10, y: 20 },
    { id: "b", x: 10, y: 20 + 200 + GAP },
    { id: "c", x: 10 + 200 + GAP * 2, y: 20 },
  ]);
});

test("layoutGroups sizes a column by its widest note", () => {
